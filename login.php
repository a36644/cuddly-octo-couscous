    ...
    <div class="app">
        <div class="bgr">
            <div class="login">
                ...
                <form id="login-form" class="auth-form auth-form-login" method="post" action="xulyDangNhap.php">
                    <div class="auth-form__container">
                        <div class="auth-form__header">
                            <h3 class="modal__inner-header">Đăng Nhập</h3>
                            <a href="register.php" style="text-decoration: none;"><span id="switch-login" class="btn-switch">Đăng ký</span></a>
                        </div>

                        <div class="auth-form__form">
                            <div class="auth-form__group">
                                <input name="phone" id="phone" type="text" class="auth-form__input" placeholder="Số điện thoại">
                            </div>
                            <div class="auth-form__group">
                                <input name="password" id="password" type="password" class="auth-form__input" placeholder="Nhập mật khẩu">
                            </div>
                        </div>
                        ...
                        <div class="auth-form__controls">
                            <a href="index.php"><input id="x-login" class="btn auth-form__controls-back" value="TRỞ LẠI" readonly></a>
