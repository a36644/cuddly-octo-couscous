...
<body>
    <div class="app">
        <?php
        if($_SESSION["logined"]=="Admin"){
        ?>
            <a href="addProduct.php" class="addprd-link"><i class="fa-solid fa-plus"></i></a>
        <?php
        }
        ?>
        <header class="header">
                ...
                <div class="grid__row app-content">
                            ...
                            <ul class="category-list">
                                ...
                                <li class="category-item">
                                    <a href="" class="category-item__link">
                                        Ốp lưng, bao da, miếng dán mặt lưng cho Điện thoại
                                    </a>
                                </li>
                                <li class="category-item">
                                    <a href="" class="category-item__link">Miếng dán khác</a>
                                </li>
                                <li class="category-item">
                                    <a href="" class="category-item__link">Ốp lưng, bao da, miếng dán thiết bị khác</a>
                                </li>
                                <li class="category-item">
                                    <a href="" class="category-item__link">Dây đeo Điện thoại và móc khóa</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                    <div class="grid__column-10">
                        <div class="home-filter">
                            <div class="home-filter__element">
                                <span class="home-filter__label">Sắp xếp theo</span>
                                <button class="btn-filter btn-primary">Phổ Biến</button>
                                <button class="btn-filter">Mới Nhất</button>
                                <button class="btn-filter">Bán Chạy</button>
                            ...
                            <div class="home-filter__page">
                                <div class="home-filter__page-wrap">
                                    <span class="home-filter__page-current">1</span>/<span class="home-filter__page-total">22</span>
                                </div>
                                <div class="home-filter__page-control">
                                    <a href="" class="home-filter__page-prev-btn home-filter__page-btn-disalbed">
                                        <i class="home-filter__page-icon fas fa-angle-left"></i>
                                    </a>
                                    <a href="" class="home-filter__page-next-btn">
                            ...
                            <div class="grid__row">
                                ...
                                ?>
                                    <div class="grid__column-2-4">
                                        <a href="product.php?id=<?=$row["id"]?>" class="product-link">
                                            <div class="home-product-item">
                                                <div class="home-product-item__img">
                                                    <img width="100%" height="auto" style="object-fit: contain;" src="./assets/img/<?= $row["img"] ?>" alt="">
                                                </div>
                                                <div class="home-product-item__info">
                                                    <div class="home-product-item__title" style="height: 32px;"><?= $row["title"] ?></div>
                                                    <div class="home-product-item__price">
                                                        <span class="home-product-item__price-old"><?= number_format($row["priceold"], "0", ".", ".") ?>đ</span>
                                                        <span class="home-product-item__price-new"><?= number_format($row["pricenew"], "0", ".", ".") ?>đ</span>
                                                    </div>
                                                    <div class="home-product-item__sold">
                                                        <div class="home-product-item__sold-rating">
                                                            <i class="fa-solid fa-star yellow-star-icon"></i>
                                                            <i class="fa-solid fa-star yellow-star-icon"></i>
                                                            <i class="fa-solid fa-star yellow-star-icon"></i>
                                                            <i class="fa-solid fa-star yellow-star-icon"></i>
                                                            <i class="fa-solid fa-star yellow-star-icon"></i>
                                                        </div>
                                                        <span class="home-product-item__sold-quantity">Đã bán <?= numberK($row["soldquantity"]) ?></span>
                                                    </div>
                                                    <div class="home-product-item__favourite">Yêu thích</div>
                                                    <div class="home-product-item__sale-off">
                                                        <span class="home-product-item__sale-off-percent"><?= $row["saleoff"] ?>%</span>
                                        ...
                                        ?>
                                            <div class="ctrl">
                                                <div class="btn-ctrl"><a href="updateProduct.php?id=<?=$row["id"]?>" onclick="return confirm('Bạn có muốn sửa sản phẩm này?')">Sửa</a></div>
                                                <div class="btn-ctrl"><a href="removeProduct.php?id=<?=$row["id"]?>" onclick="return confirm('Bạn có muốn xóa sản phẩm này?')">Xóa</a></div>
                                            </div>
                                        <?php
                                        }
                                        ?>
                        ...
                        <div class="home-pagination">
                            <button class="btn-no-outline">
                                <i class="home-pagination-icon fas fa-angle-left"></i>
                            </button>
                            <button class="btn-no-outline btn-primary">
                                <span class="home-pagination-num">1</span>
                            </button>
                            <button class="btn-no-outline">
                                <span class="home-pagination-num">2</span>
                            </button>
                            <button class="btn-no-outline">
                                <span class="home-pagination-num">3</span>
                            </button>
                            <button class="btn-no-outline">
                                <span class="home-pagination-num">4</span>
                            </button>
                            <button class="btn-no-outline">
                                <span class="home-pagination-num">5</span>
                            </button>
                            <button class="btn-no-outline btn-cursor-defaul">
                                <span class="home-pagination-more">...</span>
                            </button>
                            <button class="btn-no-outline">
                                <i class="home-pagination-icon fas fa-angle-right"></i>
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <!-- <div id="modal" class="modal close">
            ...
            <div class="modal__body"> -->
                <!-- Register form -->
                <!-- <form id="register-form" class="auth-form close" method="post" action="">
                    <div class="auth-form__container">
                        <div class="auth-form__header">
                            <h3 class="modal__inner-header">Đăng Ký</h3>
                            <span id="switch-register" class="btn-switch">Đăng nhập</span>
                        </div>

                        <div class="auth-form__form">
                            <div class="auth-form__group">
                                <input id="phonenumber" name="phonenumber" type="text" class="auth-form__input" placeholder="Số điện thoại" onkeyup="checkRegisterForm()">
                        ...
                        <div class="auth-form__controls">
                            <input id="x-register" name="x-register" class="btn auth-form__controls-back" value="TRỞ LẠI" onclick="closeRegisterForm()"></input>
                            <input type="submit" name="btn-register" id="btn-register" class="btn btn-primary" value="ĐĂNG KÝ">
                        </div>
                    </div>
                ...
                <!-- Login form -->
                <!-- <form id="login-form" class="auth-form close">
                    <div class="auth-form__container">
                        <div class="auth-form__header">
                            <h3 class="modal__inner-header">Đăng Nhập</h3>
                            <span id="switch-login" class="btn-switch">Đăng ký</span>
                        </div>
                        ...
                        <div class="auth-form__aside reset-padding">
                            <div class="auth-form__help">
                                <a href="" class="auth-form__help-link primary-color">Quên Mật Khẩu</a>
                        ...
                        <div class="auth-form__controls">
                            <input id="x-login" class="btn auth-form__controls-back" value="TRỞ LẠI"></input>
                            <input type="submit" class="btn btn-primary" value="ĐĂNG NHẬP"></input>
                        </div>
                    </div>

                    <div class="auth-form__social">
                        <a href="#" class="btn--social-icon-sms">
                            <i class="fa-solid fa-comment-sms"></i>
                            <span class="btn--social-text">SMS</span>
                        </a>
                        <a href="#" class="btn--social-icon-fb">
                            <i class="fa-brands fa-square-facebook"></i>
